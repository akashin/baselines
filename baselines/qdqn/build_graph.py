...
def build_act(make_obs_ph, q_func, num_actions, scope="deepq", learner_scope="learner", reuse=None):
...
`       See the top of the file for details.
    """
    if scope != "learner":
        with tf.variable_scope(learner_scope, reuse=True):
            learner_q_func_vars = U.scope_vars(U.absolute_scope_name("q_func"))
